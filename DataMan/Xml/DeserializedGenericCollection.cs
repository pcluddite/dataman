        ...
        private class DeserializedGenericCollection<ItemType> : DeserializedXmlObject<ICollection<ItemType>>
        {
            ...
            public override XObject Serialize()
            {
                ...
                foreach (ItemType item in DeserializedObject)
                {
                    ...
                    XObject serializedItem = XmlSerializer.Serialize(itemType, item, XmlSerializer.ValueAttributeName);
                    if (serializedItem is XElement)
                    {
                        ((XElement)serializedItem).Name = XmlSerializer.GetSerializedTypeName(itemType) ?? XmlSerializer.ElementName;
